...
data modify storage main: player append value {UID:-1,Pos:{x:0d,y:0d,z:0d},task:{result:[],raw:[],pin:[],unpin:[]}}
...
function dsc:player/bossbar/create with storage main: player[-1]
