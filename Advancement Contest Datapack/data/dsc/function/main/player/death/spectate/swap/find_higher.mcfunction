...
execute if score #temp calc.DSC <= #base died.spectating run return run function dsc:main/player/death/spectate/swap/find_higher
execute if score #temp calc.DSC >= #result UID run return run function dsc:main/player/death/spectate/swap/find_higher
