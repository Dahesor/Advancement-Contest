data modify storage dsc:task new append value {\
    ...
    all_reward:{emerald:2,score:4,recipe:"dsc_recipe:adventure/village/kill_patrol"},\
    first_reward:{emerald:4,score:5},\
    display:{lore_length:2},\
    additional_lore:{\
        all_:"",\
        first_:"",\
        recipe_sum_all:["tnt_minecart"],\
        recipe_sum_first:[],\
    },\
...
data modify storage dsc:task new[-1] merge value {\
    ...
    funcs:{\
        give:"dsc_recipe:kill_patrol/give",\
        take:"dsc_recipe:kill_patrol/take",\
