data modify storage dsc:task new append value {\
    ...
    additional_lore:{\
        all_:"",\
        first_:"",\
        recipe_sum_all:["copper_bars","copper_chain","lightning_rod"],\
        recipe_sum_first:[],\
    },\
