data modify storage dsc:task new append value {\
    ...
    node:{node:"root",default_pin:true,children:["dsc_adv:husbandry/tame_an_animal","dsc_adv:adventure/kill_all_mobs","dsc_adv:adventure/shoot_arrow","dsc_adv:adventure/throw_trident","dsc_adv:adventure/spear_many_mobs"]}\
}
...
data modify storage dsc:task new[-1] merge value {\
    ...
    display:{\
        ...
        lore:[{"translate":"task.kill_a_mob.1","italic":false,"color":"gray"}, "\n", {"translate":"task.kill_a_mob.2","italic":false,"color":"gray"}, "\n", {"translate":"task.reward","italic":false,"color":"light_purple"}, "\n", {"translate":"reward.score","italic":false,"color":"gold","with":["4"]}, "\n", {"translate":"reward.emerald","italic":false,"color":"green","with":["2"]}, "\n", {"translate":"reward.recipe","italic":false,"color":"aqua"}, [{"text": "=====", "font": "dsc:tasks/recipe", "underlined": false, "color": "white"}, {"translate": "si.iron_chestplate", "extra": ["-"], "fallback": ""}, {"translate": "si.dsc:iron_sword_p", "extra": ["-"], "fallback": ""}, {"translate": "si.wooden_spear", "extra": ["-"], "fallback": ""}, {"translate": "si.bow", "extra": ["-"], "fallback": ""}], "\n", "\n", {"translate":"task.reward_first","italic":false,"color":"light_purple"}, "\n", {"translate":"reward.score","italic":false,"color":"gold","with":["5"]}, "\n", {"translate":"reward.emerald","italic":false,"color":"green","with":["4"]}],\
        \
        recipe_name_all:[],\
        \
        recipe_name_first:[],\
