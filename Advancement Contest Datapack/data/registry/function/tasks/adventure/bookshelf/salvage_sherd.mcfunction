data modify storage dsc:task new append value {\
    ...
    all_reward:{emerald:2,score:4,recipe:"dsc_recipe:adventure/misc/get_sherd"},\
...
data modify storage dsc:task new[-1] merge value {\
    ...
    funcs:{\
        give:"dsc_recipe:get_sherd/give",\
        take:"dsc_recipe:get_sherd/take",\
