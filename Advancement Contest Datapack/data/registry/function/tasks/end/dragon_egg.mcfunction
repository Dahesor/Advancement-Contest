...
data modify storage dsc:task new[-1] merge value {\
    ...
    display:{\
        ...
        lore:[{"translate":"task.dragon_egg.1","italic":false,"color":"gray"}, "\n", {"translate":"task.reward","italic":false,"color":"light_purple"}, "\n", {"translate":"reward.score","italic":false,"color":"gold","with":["1"]}, "\n", {"translate":"task.reward_first","italic":false,"color":"light_purple"}, "\n", {"translate":"reward.score","italic":false,"color":"gold","with":["24"]}, "\n", {"translate":"reward.emerald","italic":false,"color":"green","with":["20"]}, "\n", {"translate":"reward.recipe","italic":false,"color":"aqua"}, "\n", [{"text": "", "font": "dsc:tasks/recipe", "underlined": false, "color": "white"}, {"translate": "si.diamond_chestplate", "extra": ["-"]}, {"translate": "si.diamond_leggings", "extra": ["-"]}, {"translate": "si.diamond_helmet", "extra": ["-"]}, {"translate": "si.bookshelf", "extra": ["-"]}, {"translate": "si.anvil", "extra": ["-"]}, {"translate": "si.totem_of_undying", "extra": ["-"]}]],\
        \
        recipe_name_all:[],\
        \
        recipe_name_first:[],\
