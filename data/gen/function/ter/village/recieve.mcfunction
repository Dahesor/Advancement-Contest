...
execute unless data storage gen vil.m[0].x run tellraw @a [{text:"[gen:main] 发现了区域内的新村庄",color:"dark_gray"},"(",{score:{name:"x",objective:"gen"},color:"green"},", ",{score:{name:"z",objective:"gen"},color:"green"},")"]
...
tellraw @a [{text:"[gen:main] 发现了区域内的新村庄",color:"dark_gray"},"(",{score:{name:"x",objective:"gen"},color:"green"},", ",{score:{name:"z",objective:"gen"},color:"green"},")"]