...
tellraw @a [{text:"[gen:place] 开始加载地形",color:"dark_gray"}," in ",{storage:"gen",nbt:"place.in"}, " at (",{storage:"gen",nbt:"place.x",color:"light_purple"},", ",{storage:"gen",nbt:"place.z",color:"light_purple"},")"]
