execute if score red score matches 1.. run function dsc:main/stream/end/scores/__tell_score {team:"red"}
execute if score green score matches 1.. run function dsc:main/stream/end/scores/__tell_score {team:"green"}
execute if score blue score matches 1.. run function dsc:main/stream/end/scores/__tell_score {team:"blue"}
